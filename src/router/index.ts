  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'contents',
        path: 'contents',
        component: () => import('../pages/contents/ContentsPage.vue'),
      },
      {
        name: 'news',
        path: 'news',
      ...
      },
      {
        name: 'buildings',
        path: 'buildings',
        component: () => import('../pages/buildings/BuildingsPage.vue'),
      },
      {
        name: 'upgradeAccs',
        path: 'upgradeAccs',
      ...
      },
      {
        name: 'apartmentUsers',
        path: 'apartmentUsers',
        component: () => import('../pages/apartmentUsers/ApartmentUsersPage.vue'),
      },
      {
        name: 'accounts',
        path: 'accounts',
